...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      onClick={trackEvent}
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center hover:scale-110 transition-transform duration-300 drop-shadow-2xl animate-bounce-slow hidden md:flex"
