        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1 w-full">
            ...
            <div className="bg-white rounded-2xl p-6 mb-8">
              <div className="flex items-start gap-4 mb-5 pb-5 border-b border-brand-woodLight/50">
                <MapPin className="w-5 h-5 text-brand-orange shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-brand-coffeeDark mb-1">Endereço</h3>
                  <p className="text-brand-coffee text-sm leading-relaxed">
                    Manga & Prosa<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 flex-wrap">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-brand-orange hover:bg-[#A84F28] text-white px-6 py-4 rounded-full font-bold transition-colors shadow-md w-full sm:w-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1DA851] text-white px-6 py-4 rounded-full font-bold transition-colors shadow-md w-full sm:w-auto"
              >
          ...
          {/* Map */}
          <div className="flex-1 w-full">
            <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20">
              <iframe
